...
REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/samwhelp/ubuntu-iso-builder-prev-template.git"

REF_ISO_PROFILE_REPO_BRANCH_NAME="main"

#REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ubuntu-iso-builder-prev-template/archive/refs/heads/${REF_ISO_PROFILE_REPO_BRANCH_NAME}.zip"
REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ubuntu-iso-builder-prev-template/archive/refs/heads/${REF_ISO_PROFILE_REPO_BRANCH_NAME}.tar.gz"


REF_ISO_PROFILE_REPO_ARCHIVE_FILE_NAME="${REF_ISO_PROFILE_REPO_BRANCH_NAME}.tar.gz"
REF_ISO_PROFILE_REPO_ARCHIVE_EXTRACT_DIR_NAME="ubuntu-iso-builder-prev-template-${REF_ISO_PROFILE_REPO_BRANCH_NAME}"
