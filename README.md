...
# ubuntu-iso-builder-prev-remix-xfce
...
> [ubuntu-iso-builder-prev-remix-xfce](https://samwhelp.github.io/ubuntu-iso-builder-prev-remix-xfce)

| Project |
| ------- |
| [ubuntu-iso-builder-prev-template](https://github.com/samwhelp/ubuntu-iso-builder-prev-template) |
| `+` |
| [ubuntu-iso-builder-prev-remix-xfce](https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce) |
| `=` |
| [ubuntu-iso-builder-prev-respin-xfce](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-prev-remix-xfce](https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-prev-remix-xfce.git
```


> change dir to `ubuntu-iso-builder-prev-remix-xfce`

``` sh
cd ubuntu-iso-builder-prev-remix-xfce
```
...
> change dir to `~/work/ubuntu-iso-builder-prev-remix-xfce/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-prev-remix-xfce/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-prev-remix-xfce/iso-profile/dist`
